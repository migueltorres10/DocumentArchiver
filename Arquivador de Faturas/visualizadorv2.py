...
class VizualizadorFaturas:
    def __init__(self, pasta_pdf, base_dir):
        self.pasta_pdf = pasta_pdf
        self.base_dir = base_dir
        print("📂 Buscando Faturas na pasta:", self.pasta_pdf)
        ...
        if not self.pdfs:
            messagebox.showerror("Erro", "Nenhuma Fatura encontrada na pasta 'separados'.")
            return
    ...
    def _criar_widgets(self):
        ...
        self._adicionar_label_entry("Base de Incidência:", self.entry_base)
    ...
    def salvar_dados(self):
        ...
        try:
            ...
            messagebox.showerror("Erro", "Base, IVA e Total devem ser números válidos.")
            return
        ...
        try:
            ...
            messagebox.showinfo("Sucesso", "Fatura gravada e movida com sucesso.")
            ...
            messagebox.showerror("Erro", f"Erro ao salvar ou mover fatura: {e}")
    ...
    def preencher_dados_do_qr(self, caminho_pdf):
        ...
        tipodoc = dados_qr.get("tipo_doc", "").strip()
        self.entry_tipo.delete(0, tk.END)
        self.entry_tipo.insert(0, tipodoc)            
        ...
        base = dados_qr.get("valor_tributavel", "")
        self.entry_base.delete(0, tk.END)
        self.entry_base.insert(0, base)

        iva = dados_qr.get("total_iva", "")
        self.entry_iva.delete(0, tk.END)
        self.entry_iva.insert(0, iva)

        total = dados_qr.get("total_doc", "")
        self.entry_total.delete(0, tk.END)
